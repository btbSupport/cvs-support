...
def get_quote_details( quote_name: str,currency : str) -> Dict:
    ...
    if("contact_display" in item and item["contact_display"] != None) : item["contact_display"] = '<span style="font-family:Helvetica Neue,sans-serif;font-size: 12px !important;">'+item['contact_display']+", "+item['contact_designation']+"</span>"
